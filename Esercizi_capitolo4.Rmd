...
### MARIO try mtcars[1:2,], mtcars[1:2] and mtcars[,1:2] 
```
...
diag(MM)
diagonalley(MM)
## MARIO good but you are not checking if x is a matrix...
```
...
# MARIO quest'ultimo non mi piace perchè passa dal summary, meglio sempre estralo direttamente
```
